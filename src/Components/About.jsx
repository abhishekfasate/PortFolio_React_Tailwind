...
function About() {
  return (
    <div className='w-full bg-white mt-[186px] py-0.5 relative overflow-hidden'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 text-black'>
        ...
        <div className='text-center max-md:absolute mt-[170px] sm:top-1/4'>
          <p className='font-extrabold text-4xl pl-13 m-13'>
            About Me
          </p>
          <div className='text-sm font-mono py-3 px-3'>
            Abhishek Fasate <br />
            <p className='p-4 text-align: justify;'>
